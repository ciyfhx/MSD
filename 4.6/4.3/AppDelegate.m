...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self createNewPersonWithFirstName:@"Robert"
                              lastName:@"Lewandowski"
                                   age:28];
    [self createNewPersonWithFirstName:@"Wayne"
                              lastName:@"Rooney"
                                   age:30];
    
    [self createNewPersonWithFirstName:@"Izwan"
                              lastName:@"Mahbud"
                                   age:25];
...
- (BOOL)sortPersonsByFirstName
{
    ...
    NSSortDescriptor *sortFirstName = [[NSSortDescriptor alloc]
                                       initWithKey:@"firstName"
                                       ascending:YES];
    
    fetchRequest.sortDescriptors = @[sortFirstName];
    ...
    NSLog(@"Displaying sorted list of persons...");
